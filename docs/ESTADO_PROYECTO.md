...
- **FIN-027 — Modelo de ingresos personales.** ✅ ARQ-0027 · ✅ AUD-0027 · ✅ **DEC-0027 emitida — `IMP-0027` habilitado (2º, `IMP-0028` cerrado).** CPSAO: **DTI/Score sobre NETO** + nota de copy obligatoria en Salud. CTO: **migración** FixedItem→fuentes (no coexistencia, §32); `NetIncomeService` única def.; regresión sin perfil = idéntico; `withheldAtSource`. **En espera del `IMP-0027` del Arquitecto.** `docs/oficial/DEC-0027-Modelo-de-Ingresos.md`.
