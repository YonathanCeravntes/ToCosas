...
- **FIN-028 — Gestión de movimientos (editar/eliminar).** **ARQ RETENIDO por el CTO** — toca el módulo Registrar/Transacciones, dispara la instrucción permanente del Fundador de hacer observaciones previas. No arranca hasta recibirlas (`docs/correspondencia/FIN-028-Gestion-de-Movimientos.md`).
