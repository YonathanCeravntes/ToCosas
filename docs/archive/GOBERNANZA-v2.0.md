...
> **ARCHIVADA 2026-07-06.** Reemplazada por Gobernanza v3.0 (`docs/GOBERNANZA.md`),
> que incorpora la Gobernanza Estratégica del Producto (CPSAO, laboratorio de ideas,
> `docs/producto/`) y los principios transversales de independencia de roles,
> trazabilidad completa, versionado documental y archivo histórico. Conservada aquí
> por la regla de archivo histórico (Gobernanza v3.0, Parte III §20) — nunca se
> elimina documentación oficial.
